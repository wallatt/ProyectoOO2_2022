...
public class UserController {
	...
	public String editarUser(@PathVariable("id") int id, @ModelAttribute("user") UserModel userModel) {
		...
		// Guardo el username antes de ser modificado
		...
		// Comprado y cierro la sesion si es el mismo username , porlotanto si un admin edita otro usuario no cierra su sesion
		if(username.equalsIgnoreCase(userAuth)) {
