...
public class EspacioService implements IEspacioService {
	...
	public void generarEspacioMes(String fechaInicio, String fechaFinalizacion, char turno, Aula aula)
			throws Exception {
...
//    }
	...
	public List<Espacio> findByCodCurso(String codCurso) {
		return espacioRepository.findByCodCurso(codCurso);
	}

	@Override
	public List<Espacio> findAllAsignados() {
		return espacioRepository.findAllAsignados();
	}
